...
L["Mount"] = "Ездовые животные";
	...
	L["You are not in a flyable area and you have no selected ground mount."] = "Вы находитесь на территории где полёты запрещены, и у вас не выбрано наземное животное.";
...
L["Choose the skin displayed by the Cryolysis sphere."] = "Выберите шкурку для сферы Cryolysisа.";
...
L["Down"] = "Вниз";
L["Left"] = "Влево";
L["Growth Direction"] = "Направление меню";
L["Adjust which way this menu grows"] = "Настройка направления меню";
L["Show Item Count"] = "Показ кол-ва предметов";
L["Display the item count on this button"] = "Отображать число предметов на данной кнопке";
...
L["Ctrl"] = "Ctrl";
	...
	L["Adjust various settings for this button."] = "Настройка параметров данной кнопки.";
	...
	L["Re-scan Mounts"] = "Перепроверка ездовых животных";
...
L["Click to open menu."] = "Кликните для открытия";
	...
	L["Restock all reagents?"] = "Запастись всеми реагентами?";
	L["Yes"] = "Да";
	L["No"] = "Нет";
	...
	L["Adjust the amount of "] = "Какое количество ";
...
-- Error messages
------------------------------------------------------------------------------------------------------
L["Invalid name, please check your spelling and try again!"] = "Неверное название, пожалуйста, проверьте заклинание и попробуйте снова!";
